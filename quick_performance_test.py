...
def main():
    ...
    rating = 'EXCELLENT' if conv_per_sec >= 15 else 'GOOD' if conv_per_sec >= 10 else 'FAIR' if conv_per_sec >= 5 else 'NEEDS_IMPROVEMENT'
    ...
    print(f"  • Storage Efficiency: {sync_metrics['storage_efficiency_conversations_per_mb']:.1f} conv/MB")
