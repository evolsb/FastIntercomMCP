...
class StatusTracker:
    ...
    def start_process(self, process_id: str, process_type: str, description: str, 
                     workspace: Optional[str] = None, **metadata) -> ProcessStatus:
    ...
    def update_process(self, process_id: str, progress: Optional[Dict[str, Any]] = None, 
                      log_files: Optional[List[str]] = None, **metadata):
    ...
    def get_recent_processes(self, limit: int = 10, 
    ...
    def aggregate_logs_for_process(self, process_id: str, output_file: Optional[str] = None) -> str:
...
_global_status_tracker: Optional[StatusTracker] = None
...
def start_process_tracking(process_id: str, process_type: str, description: str, 
                          workspace: Optional[str] = None, **metadata) -> ProcessStatus:
...
def update_process_tracking(process_id: str, progress: Optional[Dict[str, Any]] = None, 
                           log_files: Optional[List[str]] = None, **metadata):
